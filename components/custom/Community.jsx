...
function ReviewsList() {
  ...
  if (reviews.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-40 text-neutral-500 border border-dashed border-neutral-800 rounded-2xl">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {reviews.map((review) => (
        <div
          key={review._id}
          className="bg-neutral-900/40 border border-neutral-800 rounded-2xl p-5 hover:border-neutral-700 transition-colors duration-300"
        >
            ...
            <div className="min-w-0">
              ...
              <div className="flex gap-0.5">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="h-3 w-3 text-neutral-200 fill-neutral-200"
                  />
                ))}
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center space-y-4 mb-14">
          ...
          <p className="text-neutral-400 max-w-2xl mx-auto">
            Real reviews from real people. Every review is screened by AI — only
            genuine, respectful feedback gets published.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="lg:col-span-1 bg-neutral-900/50 backdrop-blur-xl rounded-2xl border border-neutral-800 p-6 h-fit lg:sticky lg:top-24">
            ...
            <p className="text-neutral-500 text-sm mb-5">
              Share your experience — it appears on this wall instantly after AI
              approval.
            </p>
            <div className="space-y-3">
              ...
              <input
                ...
                maxLength={200}
                placeholder="Social / portfolio link (optional)"
                className="w-full bg-black/60 border border-neutral-800 rounded-lg p-3 text-neutral-100 placeholder-neutral-500 focus:border-neutral-500 focus:ring-2 focus:ring-white/10 outline-none text-sm transition-all duration-200"
              />
              <textarea
                value={text}
