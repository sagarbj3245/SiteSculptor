    ...
    <div className="border-y border-neutral-900 bg-neutral-950/60 overflow-hidden py-2.5">
      <div className="flex gap-8 w-max font-mono text-xs text-neutral-600 animate-[marquee_30s_linear_infinite]">
        ...
        {TICKER_ITEMS.map((item, i) => (
          <span key={`b${i}`} className="flex items-center gap-8 shrink-0" aria-hidden="true">
            <span>{item}</span>
            <span className="text-neutral-800">•</span>
          </span>
        ))}
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <BrowserFrame label="sitesculptor — building" icon={Terminal}>
            <div className="relative">
              <img
                ...
                className="w-full h-56 object-cover grayscale contrast-125 opacity-90"
              />
            ...
            <div className="px-4 py-3 border-t border-neutral-800 flex items-center justify-between">
              <p className="text-sm text-neutral-400">
                The AI writes real React code, live
              </p>
          ...
          <BrowserFrame label="kickvault.shop — generated site" icon={Globe}>
            <div className="relative h-56 bg-neutral-950 overflow-hidden select-none">
              ...
              <div className="flex items-center justify-center h-full pb-10">
                <div className="bg-neutral-900/70 border border-neutral-800 rounded-xl p-4 w-48 animate-[float-soft_5s_ease-in-out_infinite]">
                  <div className="h-16 rounded-lg bg-gradient-to-b from-neutral-700 to-neutral-800 mb-3 flex items-center justify-center text-2xl">
                    👟
                  </div>
            ...
            <div className="px-4 py-3 border-t border-neutral-800 flex items-center justify-between">
              <p className="text-sm text-neutral-400">
                Real visitors use what you built
              </p>
